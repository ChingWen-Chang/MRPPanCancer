...
library(maftools)
laml.WT <- read.maf(maf = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/mutation/dataset_WT.maf', clinicalData = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/mutation/dataset_WT_clinical.tsv')
laml.MD_HD <- read.maf(maf = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/mutation/dataset_MD_LD.maf', clinicalData = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/mutation/dataset_MD_LD_clinical.tsv')
laml.LD <- read.maf(maf = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/dataset_SD.maf', clinicalData = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/dataset_SD_clinical.tsv')
...
pdf(file="Pan_cancer_mutation_WT.TCGA.pdf",width=7, height=10,compress=TRUE,useDingbats=F)
oncoplot(maf = laml.WT,
         ...
         mutsigQval = 0.000000000000001,
         colors = col,
         annotationColor = anno_cols, top = 15)
dev.off() 

pdf(file="Pan_cancer_mutation_MD_HD.TCGA.pdf",width=7, height=10,compress=TRUE,useDingbats=F)
oncoplot(maf = laml.MD_HD,
         clinicalFeatures = c('Cancer_Type', 'Overall_Survival_Status'),
         sortByAnnotation = T,
         mutsig = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/OUTPUT.sig_genes.txt',
         mutsigQval = 0.000000000000001,
         colors = col,
         annotationColor = anno_cols, top = 20)
dev.off()

pdf(file="Pan_cancer_mutation_LD.TCGA.pdf",width=7, height=8,compress=TRUE,useDingbats=F)
oncoplot(maf = laml.LD,
         clinicalFeatures = c('Cancer_Type', 'Overall_Survival_Status'),
         sortByAnnotation = T,
         mutsig = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/SD.OUTPUT.sig_genes.txt',
         mutsigQval = 0.000000000000001,
         colors = col,
         annotationColor = anno_cols, top = 20)
dev.off()

pdf(file="Pan_cancer_mutation_WT.TCGA1.pdf",width=7, height=8,compress=TRUE,useDingbats=F)
oncoplot(maf = laml.WT,
         clinicalFeatures = c('Cancer_Type', 'Overall_Survival_Status'),
         sortByAnnotation = T,
         #mutsig = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/WT_OUTPUT.sig_genes.txt',
...
pdf(file="Pan_cancer_mutation_MD_HD.TCGA1.pdf",width=7, height=8,compress=TRUE,useDingbats=F)
oncoplot(maf = laml.MD_HD,
         clinicalFeatures = c('Cancer_Type', 'Overall_Survival_Status'),
         sortByAnnotation = T,
         ...
         colors = col,
         annotationColor = anno_cols, top = 30)
dev.off()

pdf(file="Pan_cancer_mutation_LD.TCGA1.pdf",width=7, height=8,compress=TRUE,useDingbats=F)
oncoplot(maf = laml.LD,
         clinicalFeatures = c('Cancer_Type', 'Overall_Survival_Status'),
         sortByAnnotation = T,
         #mutsig = '/Users/ching-wenchang/Documents/Pan_cancer_mutation2/SD_OUTPUT.sig_genes.txt',
         #mutsigQval = 0.0000001,
         colors = col,
         annotationColor = anno_cols, top = 20)
dev.off()
...
pt.vs.rt <- mafCompare(m1 = laml.MD_HD, m2 = laml.WT, m1Name = 'MDHD', m2Name = 'WT', minMut = 5)
print(pt.vs.rt)
write.table(pt.vs.rt$results,"Pan_cancer_mutation_compre_MDHD_TCGA.txt",sep="\t",quote = F)
pdf(file="Pan_cancer_mutation_compre_MDHD_WT_TCGA1.pdf",width=4, height=3,compress=TRUE,useDingbats=F)
forestPlot1(mafCompareRes = pt.vs.rt, pVal = 0.000000000000005, color = c('royalblue', 'maroon'), geneFontSize = 0.9)
dev.off()
...
pdf(file="Pan_cancer_mutation_compre_MDHD_WT_TCGA_TP53.pdf",width=4, height=6,compress=TRUE,useDingbats=F)
lollipopPlot2(m1 = laml.MD_HD, m2 = laml.WT, gene = "TP53", AACol1 = "HGVSp", AACol2 = "HGVSp", m1_name = "Deletion", m2_name = "WT")
dev.off()

#lollipop plot for TP53 in WT group
pdf(file="Pan_cancer_mutation_WT_TCGA_TP53.pdf",width=4, height=1.6,compress=TRUE,useDingbats=F)
lollipopPlot(maf = laml.WT, gene = 'TP53', AACol = 'HGVSp', showMutationRate = TRUE, labelPos = 248)
dev.off()

#lollipop plot for TP53 in MDHD group
pdf(file="Pan_cancer_mutation_MDHD_TCGA_TP53.pdf",width=4, height=3.8,compress=TRUE,useDingbats=F)
...
OS<-ggsurvplot(fit2,#facet.by = "Cancer_Type",
               ...
               font.y = c(10),
               font.tickslab = c(10),
               fontsize=10,break.time.by = 12,xlim = c(0, 384))
pdf(file="Pan_cancer_p53_del_Sur_TCGA.pdf",width=4, height=4,compress=TRUE,useDingbats=F)
OS
dev.off()
